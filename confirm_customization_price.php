...
try {
    // Verify that the request belongs to the user and is in 'approved' status
    $checkQuery = "SELECT id, price, status FROM customization_requests 
    ...
    // Note: 'accept' is now handled by checkout process (process_customization_order.php)
    ...
    $updateQuery = "UPDATE customization_requests 
