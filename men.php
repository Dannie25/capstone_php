...
<body>
  ...
  // Define available subcategories for men (should match admin options)
  $subcategories = [
    'all' => 'All Products',
    'Shirts' => 'Shirts',
    'Polos' => 'Polos',
  ...
  <section class="page-title">
    <div class="container">
      <h1><i class="fas fa-mars" style="margin-right: 8px;"></i>Men's Collection</h1>
      <p>Discover our curated selection of stylish and comfortable men's fashion</p>
    </div>
  </section>
...
?>
      ...
      ?>
        <div class="no-products" style="grid-column: 1 / -1; text-align: center; padding: 80px 20px; background: white; border-radius: 16px; box-shadow: 0 4px 16px rgba(91, 107, 70, 0.08);">
          ...
          <p style="color: #666; font-size: 16px; line-height: 1.6;">We're working on adding new items to our men's collection.<br>Please check back soon!</p>
        </div>
      <?php endif; ?>
    </div>
  </div>
